...
public class NewCalendarEventsTests extends AbstractTestBase {
    ...
    public void verifyColumnNamesTest() {
       ...
       /* List <String> actual = Arrays.asList(calendarEventsPage.getColumnNames().toString());
        System.out.println(actual); tried for myself
*/
...
//    public Object[] eve
    ...
    public Object[][] calendarEvents() {
        return new Object[][]{
                {"Daily Stand-up", "Scrum meeting to provide daily updates"},
                {"Sprint Review", "Scrum meeting where team discusses previous sprint"},
                {"Sprint Planning", "Scrum meeting where team discusses backlog for following sprint"}
        };
    }
}
